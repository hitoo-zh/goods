            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="javascript:void(0);" class="btn btn-danger btn-module-chuku-all">
                            出库 <i class="fa fa-plus"></i>
                        </a>
                        <a href="javascript:void(0);" class="btn btn-danger btn-module-ruku-all">
                            入库 <i class="fa fa-plus"></i>
                        </a>
                    </div>
                </div>
                <%--<div class="col-md-9">
...
<script>
     ...
     */
    function addModule(){
        tools.loadPage("/goods/add", null, function(html){
    ...
    function editModule(id){
        $.post("/goods/edit", {"id":id}, function(html){
    ...
    function deleteById(id){
        layer.confirm("确定删除么？",function() {
            tools.post("/goods/delete", {"id":id}, function (data) {
                if(data.success){
    ...
    function rukuByIds(a){
        var ids = getIds($('#table').find(".checkbox-child:checked"));
        if(ids.length === 0){
            layer.msg("请先选择要操作的商品！", {icon: 2,time:1000});
            return;
        }
            $.post("/goods/rukuByIds", {"ids":ids.join(","),"a":a}, function(html){
