            ...
            <table data-current-page="${pageInfo.pageNum}" data-page-size="${pageInfo.pageSize}"
                ...
                <c:forEach var="item" items="${pageInfo.list}" varStatus="status">
                    <tr>
                       ...
                       <%-- <td>${item.pid}</td>--%>
                        <td>${item.userName}</td>
                        <td>${ssm:dateToStringTime(item.createTime)}</td>
                        <td>
...
<script>
     ...
     */
    function addModule(){
        tools.loadPage("/goodsclass/add", null, function(html){
    ...
    function editModule(id){
        $.post("/goodsclass/edit", {"id":id}, function(html){
    ...
    function deleteById(id){
        layer.confirm("确定删除么？",function() {
            tools.post("/goodsclass/delete", {"id":id}, function (data) {
                if(data.success){
    ...
    function deleteByIds(){
        ...
        layer.confirm("确定删除选中信息么？",function(){
            tools.post("/goodsclass/deleteByIds",{"ids":ids.join(",")},function(data){
                if(data.success){
